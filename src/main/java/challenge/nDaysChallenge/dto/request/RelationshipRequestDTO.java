...
@Builder
  public RelationshipRequestDTO (String id, String nickname, int image, LocalDateTime requestedDate, LocalDateTime acceptedDate, String relationshipStatus, List<String >friendsList){
    this.id=id;
